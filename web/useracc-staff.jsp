<%-- 
    Document   : useracc-staff
    Created on : 18 Jan 2025, 4:05:57 pm
    Author     : DELL
--%>
...
<body>
    ...
    <table border="1" id="userTable">
        ...
        <tbody>
            ...
            <div class="content"><p>Number of users: ${users.size()}</p></div>
            <!-- Export Buttons -->
            <div>
                ...
                <c:forEach var="user" items="${users}">
                    <tr>
                        ...
                        <td class="actions">
                            <div class="button">
                                <a href="UserServlet?action=edit&userID=${user.userID}">
                                    <button class="action-btn edit-btn"><i class="fas fa-pencil-alt"></i></button>
                                </a>
                                <a href="UserServlet?action=delete&userID=${user.userID}" onclick="return confirm('Are you sure you want to delete this user?')">
