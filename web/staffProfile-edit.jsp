...
<head>
    ...
    <title>MINDEASE - Manage Staff Profile </title>
    <style>
        body {
...
<body>
   <!-- Navigation Bar -->
        ...
        <div class="signup-container">
            <form action="StaffServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="departmentS" name="departmentS" value="<%= staff.getDepartmentS() %>" required>
                </div>
    ...
    <script>
        function goBack() {
            window.location.href = "StaffProfile.jsp"; // Change this to your actual profile page URL
        }
    </script>
