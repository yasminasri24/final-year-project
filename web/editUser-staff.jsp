<%-- 
    Document   : editUser-staff
    Created on : 19 Jan 2025, 2:20:21 am
    Author     : DELL
--%>
            ...
            <c:if test="${not empty user}">
                <form action="UserServlet?action=update" method="post">
                    ...
                    <div class="btn-container">
                        ...
                        <button class="cancel-btn"><a href="UserServlet?action=list" class="btn btn-secondary">Cancel</a></button>
                    </div>
                </form>
            </c:if>

            <!-- Display an error message if there is an issue with the user data -->
