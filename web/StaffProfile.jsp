<%-- 
    ...
    Created on : 3 Mar 2025, 3:56:44 pm
    Author     : DELL
--%>
...
<head>
    ...
    <title>MINDEASE - Staff Profile</title>
    <style>
        body {
        ...
        .profile-container {
            text-align: center;
            margin-top: -3%; /* Adjust spacing below navbar */
        }
...
<body>
    ...
    <div class="profile-container">
        ...
        <h1>Profile <%= staff.getUsername() %></h1>

        <!-- Profile Container -->
        <div class="container">
            <div class="info-container">
                <div class="info"><span>Username:</span> <%= staff.getUsername() %></div>
                <div class="info"><span>Email:</span> <%= staff.getEmail() %></div>
                <div class="info"><span>Staff Name:</span> <%= staff.getStaffname() %></div>
                <div class="info"><span>Department:</span> <%= staff.getDepartmentS() %></div>
            </div>
            <div class="buttons">
                <a href="StaffServlet?action=editProfile" class="btn btn-update">Update</a>
