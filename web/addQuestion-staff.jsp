<%-- 
    Document   : addQuestion-staff
    Created on : 5 Mar 2025, 9:39:50 pm
    Author     : DELL
--%>
...
<head>
    ...
    <title>MINDEASE - Add Assessment Questions</title>
    <style>
        body {
        ...
        <div class="container">
            <div class="card">
                ...
                <h2>Add a New Question</h2>
                    <form action="QuestionServlet?action=add" method="post">
                        ...
                        <div class="btn-container">
                            <button class="update-btn" type="submit">Add Question</button>
